    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('governance_process_json', models.JSONField(blank=True, max_length=1000, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('evaluation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='policyengine.policyevaluation')),
