...
def govern_action(action):
    ...
    """
    from policyengine.models import (ConstitutionAction,
                                     ConstitutionActionBundle, PlatformAction,
                                     PlatformActionBundle, Proposal)
...
def evaluate_proposal_inner(proposal, is_first_evaluation: bool):
    from policyengine.models import (ConstitutionAction, PlatformAction,
                                     Policy, Proposal)
