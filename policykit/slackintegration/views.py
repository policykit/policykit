...
from policyengine.models import CommunityAction, BooleanVote, NumberVote, CommunityRole, CommunityPolicy, Proposal, LogAPICall, BaseAction, CommunityActionBundle
    ...
    if res['ok']:
        if state =="user": 
            ...
            if not s.exists():
                ...
                user_group.community_integration = integration
                user_group.save()
            else:
